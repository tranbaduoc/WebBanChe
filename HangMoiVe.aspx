<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="HangMoiVe.aspx.cs" Inherits="DoAn4.WebForm11" Title="Hàng mới về" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    ...
    <asp:Label ID="lblTieuDe" runat="server" Font-Bold="False" Font-Names="Arial" 
        Font-Size="Larger" ForeColor="#333333">chè mới về</asp:Label>
    </div>
    <asp:DataList ID="sanphammoi" runat="server" HorizontalAlign="Center" 
        ...
        <img id="anh" runat="server" src='<%# "~/AnhChe/AnhSanPham/"+Eval("Image") %>' />
       </a>
       </div>
            <div class="dong">
