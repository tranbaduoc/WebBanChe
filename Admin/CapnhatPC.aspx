        ...
        <div>
            <center>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Mã LOẠI chè" SortExpression="Style_ID">
                            <ItemTemplate>
                                <asp:Label ID="lbMa" runat="server" Text='<%# Bind("Style_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="TÊN LOẠI chè" SortExpression="Style_Name">
                            <ItemTemplate>
