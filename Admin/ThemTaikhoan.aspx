...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="cb2" runat="server" style="margin-left: 2px">
                            ...
                            <asp:ListItem>Thống kê chè bán chạy</asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
                    <td>
                        <asp:CheckBoxList ID="cb3" runat="server">
                            ...
                            <asp:ListItem>Cập nhật chè</asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
                </tr>
            </table>
    ...
    <div style="text-align: center; height: 42px; margin-top: 0px;">
        <asp:Button ID="btnMoi" runat="server" onclick="btnMoi_Click" Text="Làm mới" 
            Width="60px" />
&nbsp;&nbsp;
        <asp:Button ID="btnthem" runat="server" Text="Cập nhật" Width="73px" 
