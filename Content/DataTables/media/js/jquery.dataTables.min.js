...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ đến _END_ trong tổng số _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị 0 đến 0 trong tổng số 0 bản ghi",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
