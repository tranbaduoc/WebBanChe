...
namespace DoAn4
{
	...
	public partial class tbl_Comment : INotifyPropertyChanging, INotifyPropertyChanged
	{
        ...
        private System.Nullable<int> _Cmt_ParentID;

        private EntityRef<tbl_Comment> _tbl_Comment;
        private EntityRef<tbl_Producer> _tbl_Producer;
        private EntityRef<tbl_Customer> _tbl_Customer;
        ...
        partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
        partial void OnCreating(System.DateTime value);
        partial void OnCreated();
        partial void OnProduct_IDChanging(int value);
    partial void OnProduct_IDChanged();
    ...
    partial void OnCmt_IDChanged();
        ...
        partial void OnCreateChanging(System.DateTime value); 
        partial void OnCmt_ContentChanged();
        partial void OnCmt_ParentIDChanging(System.Nullable<int> value);
    partial void OnCmt_ParentIDChanged();
    #endregion
		
		public tbl_Comment()
		{
            this._tbl_Producer = default(EntityRef<tbl_Producer>);
			this._tbl_Comment = default(EntityRef<tbl_Comment>);
			this._tbl_Customer = default(EntityRef<tbl_Customer>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage= "_Cmt_ParentID", DbType="Int", CanBeNull=false)]
		public int? Cmt_ParentID
        {
			get
			{
				return this._Cmt_ParentID;
			}
			set
			{
				if ((this._Cmt_ParentID != value))
				{
					this.OnCmt_ParentIDChanging(value);
					this.SendPropertyChanging();
					this._Cmt_ParentID = value;
					this.SendPropertyChanged("Cmt_ParentID");
					this.OnCmt_ParentIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage= "_Cmt_Content", DbType= "ntext NOT NULL")]
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_User", DbType = "varchar(20) NOT NULL")]
        public string User
        {
            get
            {
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_NameUser", DbType = "ntext NOT NULL")]
